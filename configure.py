...
_EXTERNAL_DEPS = dict(
    sxplayer=dict(
        ...
        sha256='7de56615d0bbe83d95c87c2dbc1cbf89c95c0b3fb5de1f0af5e709455d51c3f6',
    ),
    pkgconf=dict(
        version='1.7.4',
    ...
    renderdoc_Windows=dict(
        ...
        sha256='d752913f984e18e70dc9fa91c280c8472f925ca9d673845385f84aefc9e94548',
    ),
...
def _rmtree(path, ignore_errors=False, onerror=None):
    ...
    encoutering read-only files or directories lacking the executable
    permission.
    """
    try:
