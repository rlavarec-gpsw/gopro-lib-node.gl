...
class _CompareFingerprints(CompareSceneBase):
    ...
    @staticmethod
    def serialize(data: list[list[int]]) -> str:
        ret = ""
    ...
    @staticmethod
    def deserialize(data: str) -> list[list[int]]:
        ret = []
    ...
    @staticmethod
    def _get_plane_hashes(buf) -> list[int]:
        hashes = []
        linesize = _HSIZE + 1
    ...
    def get_out_data(self, dump: bool = False, func_name: Optional[str] = None) -> list[list[int]]:
        hashes = []
        dump_index = 0
