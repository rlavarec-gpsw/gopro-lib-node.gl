...
_TONEMAP_OPERATORS = ('bt2390', 'reinhard', 'reinhard_extended', 'reinhard_jodie', 'aces')
...
def hdr_to_sdr(cfg, rotate=True, debug_logavg=True, honor_logavg=True, tonemap=_TONEMAP_OPERATORS[0], desat=_DESAT_METHODS[0]):
