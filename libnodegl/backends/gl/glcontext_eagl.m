...
static int eagl_init_wrapped(struct glcontext *ctx, uintptr_t display, uintptr_t window, uintptr_t other)
{
    struct eagl_priv *eagl = ctx->priv_data;
...
static void eagl_uninit_wrapped(struct glcontext *ctx)
{
    struct eagl_priv *eagl = ctx->priv_data;
...
const struct glcontext_class ngli_glcontext_eagl_class = {
    .init = eagl_init,
    .init_wrapped = eagl_init_wrapped,
    .uninit = eagl_uninit,
    .resize = eagl_resize,
...
const struct glcontext_class ngli_glcontext_eagl_class = {
    .init = eagl_init_wrapped,
    .uninit = eagl_uninit_wrapped,
    .make_current = eagl_make_current,
    .get_texture_cache = eagl_get_texture_cache,
    .get_proc_address = eagl_get_proc_address,
    .get_handle = eagl_get_handle,
