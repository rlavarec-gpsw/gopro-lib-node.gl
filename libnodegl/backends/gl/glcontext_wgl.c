...
static void wgl_uninit_wrapped(struct glcontext *ctx)
{
    struct wgl_priv *wgl = ctx->priv_data;
...
const struct glcontext_class ngli_glcontext_wgl_wrapped_class = {
    .init = wgl_init_wrapped,
    .uninit = wgl_uninit_wrapped,
    .make_current = wgl_make_current,
    .get_proc_address = wgl_get_proc_address,
    .get_handle = wgl_get_handle,
    .priv_size = sizeof(struct wgl_priv),
