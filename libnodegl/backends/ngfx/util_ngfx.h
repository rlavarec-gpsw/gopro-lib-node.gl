...
ngfx::CompareOp to_ngfx_compare_op(int compare_op);
ngfx::StencilOp to_ngfx_stencil_op(int stencil_op);
...
ngfx::RenderPass* get_render_pass(ngfx::GraphicsContext* ctx,
