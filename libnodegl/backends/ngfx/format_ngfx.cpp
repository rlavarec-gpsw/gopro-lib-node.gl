...
int to_ngli_format(PixelFormat format)
{
    static const map<PixelFormat, int> format_map = {
        ...
        {PIXELFORMAT_D24_UNORM_S8_UINT,  NGLI_FORMAT_D24_UNORM_S8_UINT  },
        {PIXELFORMAT_D32_SFLOAT,         NGLI_FORMAT_D32_SFLOAT         },
        {PIXELFORMAT_D32_SFLOAT_S8_UINT, NGLI_FORMAT_D32_SFLOAT_S8_UINT }
    };
...
ngfx::PixelFormat to_ngfx_format(int format)
{
    static const map<int, PixelFormat> format_map = {
        ...
        {NGLI_FORMAT_D24_UNORM_S8_UINT,   PIXELFORMAT_D24_UNORM_S8_UINT },
        {NGLI_FORMAT_D32_SFLOAT,          PIXELFORMAT_D32_SFLOAT        },
        {NGLI_FORMAT_D32_SFLOAT_S8_UINT,  PIXELFORMAT_D32_SFLOAT_S8_UINT}
    };
    return format_map.at(format);
}
