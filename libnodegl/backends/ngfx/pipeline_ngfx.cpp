...
static int pipeline_graphics_init(pipeline *s, const pipeline_params *params)
{
    ...
    blendParams.colorBlendOp              = to_ngfx_blend_op(gs->blend_op);
    blendParams.srcColorBlendFactor       = to_ngfx_blend_factor(gs->blend_src_factor);
    blendParams.dstColorBlendFactor       = to_ngfx_blend_factor(gs->blend_dst_factor);
    blendParams.alphaBlendOp              = to_ngfx_blend_op(gs->blend_op_a);
    blendParams.srcAlphaBlendFactor       = to_ngfx_blend_factor(gs->blend_src_factor_a);
    blendParams.dstAlphaBlendFactor       = to_ngfx_blend_factor(gs->blend_dst_factor_a);
    ...
    stencilParams.stencilReadMask         = gs->stencil_read_mask;
    stencilParams.stencilWriteMask        = gs->stencil_write_mask;
    stencilParams.frontStencilFailOp      = to_ngfx_stencil_op(gs->stencil_fail);
    stencilParams.frontStencilDepthFailOp = to_ngfx_stencil_op(gs->stencil_depth_fail);
    stencilParams.frontStencilPassOp      = to_ngfx_stencil_op(gs->stencil_depth_pass);
    stencilParams.frontStencilFunc        = to_ngfx_compare_op(gs->stencil_func);
    stencilParams.backStencilFailOp       = to_ngfx_stencil_op(gs->stencil_depth_fail);
    stencilParams.backStencilDepthFailOp  = to_ngfx_stencil_op(gs->stencil_depth_fail);
    stencilParams.backStencilPassOp       = to_ngfx_stencil_op(gs->stencil_depth_pass);
    stencilParams.backStencilFunc         = to_ngfx_compare_op(gs->stencil_func);
    stencilParams.stencilRef              = gs->stencil_ref;
