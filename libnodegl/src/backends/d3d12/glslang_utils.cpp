...
{
    static std::vector<glslang_stage_t> stages;
    struct InitStages
    {
        InitStages()
        {
            stages[NGLI_PROGRAM_SHADER_VERT] = GLSLANG_STAGE_VERTEX;
            stages[NGLI_PROGRAM_SHADER_FRAG] = GLSLANG_STAGE_FRAGMENT;
            stages[NGLI_PROGRAM_SHADER_COMP] = GLSLANG_STAGE_COMPUTE;
        };
    };
    static InitStages gInitStages;
