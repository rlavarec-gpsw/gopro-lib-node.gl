...
struct gpu_ctx_class {
    ...
    int (*begin_wrapped)(struct gpu_ctx *s);
    int (*end_wrapped)(struct gpu_ctx *s);
    ...
    int (*pipeline_update_buffer)(struct pipeline *s, int index, struct buffer *buffer, int offset, int size);
