...
export NGL_DLL_DIRS=$CURRENT_DIR'\venv\Scripts'
export WSLENV=VULKAN_SDK/w:PKG_CONFIG/w:PKG_CONFIG_PATH/w:PKG_CONFIG_ALLOW_SYSTEM_LIBS/w:PKG_CONFIG_ALLOW_SYSTEM_CFLAGS/w:PKG_CONFIG_DONT_DEFINE_PREFIX/w:VCVARS64/w:NGL_DLL_DIRS/w
