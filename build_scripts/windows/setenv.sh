...
export WSLENV=$WSLENV:PKG_CONFIG/w:PKG_CONFIG_PATH/w:PKG_CONFIG_ALLOW_SYSTEM_LIBS/w:PKG_CONFIG_ALLOW_SYSTEM_CFLAGS/w:PKG_CONFIG_DONT_DEFINE_PREFIX/w:VCVARS64/w
export WSLENV=$WSLENV:VIRTUAL_ENV/w:PYTHONHOME/w
